...
public class NotFoundException extends RuntimeException {
    ...
    public static final String HOMEPAGE_BANNER_NOT_FOUND = "Homepage banner not found!";
    public static final String HOMEPAGE_WEEKLY_OFFER_NOT_FOUND = "Homepage weekly offer not found!";
    ...
    public static final String PRODUCT_VIDEO_NOT_FOUND = "Product Video not found!";
